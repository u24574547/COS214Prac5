...
public:
     ...
     */
    Flowering(std::string species, int currentEnvironment, int growthLevel, int amountWateredToday, double growthRate, int preferredEnvironment, PlantState* state);
